...
class BetweenessCentrality {
    public:
        ...
        * @param skipNoPaths Whether or not to skip pairs of points with no path
        */
        map<int, int> getAllScoresDijkstrasProbabilistic(const Graph& graph, int sampleSize, bool skipNoPaths = true);
